...
###### By Eric Zhong (https://github.com/zhongeric/rash-classifier/) ##########
...
if args.keywords:
    ...
    search_keyword = [str(item) for item in x]
...
#                time.sleep(.1)
        ...
        while (k < limit):
            ...
            try:
                ...
                if ".jpg" in image_name:
                    output_file = open(main_directory + "/" + dir_name + "/" + image_name, 'wb') # + str(k+1)
                    out_dir = main_directory + "/" + dir_name + "/" + image_name
                    #image_name = image_name.replace('.','a')
                else:
                    print("File format unsupported...")
                    #output_file = open(main_directory + "/" + dir_name + "/" + str(k + 1) + image_name + ".jpg", 'wb')
                    #i_name = image_name.replace('.','a')
                    #image_name = image_name + ".jpg"
